...
We are a B2B company with an office and warehouse in Warsaw. We do not sell retail or process automatic online purchases. Every order is discussed directly with the customer because the availability, composition and character of second-hand clothing change from one batch to another.

Our role is to connect the needs of a particular shop with the goods available now and provide the information needed to make a considered purchasing decision.
...
- availability of the selected line;
- the current price and minimum quantity;
- the grade and approximate batch composition;
- photos or video of the goods available;
- collection or transport arrangements.

## Why the individual batch matters

Second-hand clothing is not identical in every delivery. Brands, sizes, colours, styles and the proportions of individual items can vary. Catalogue descriptions are therefore a guide, while the details are confirmed for the batch actually available.

We believe in a simple and transparent approach: customers should know which grade they are buying, see the available materials and understand the terms before making a decision.

## How working with EuroSortex works

1. **Contact us on WhatsApp or by phone.** Tell us which assortment you need, the planned quantity and the delivery city.
2. **A manager checks availability.** You receive the current price, a description, and photos or video of the batch.
