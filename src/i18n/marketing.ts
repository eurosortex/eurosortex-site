...
export const productPageCopy: Record<Locale, ProductPageCopy> = {
  pl: {
    ...
    metaDescription: (p) => `${p.description.pl} ${formatPrice(p.netPricePlnPerKg, 'pl')} zł/kg netto, minimum 20 kg. Sprawdź aktualną partię i zdjęcia w EuroSortex. Dostawa na terenie całej UE i pomoc z transportem.`,
  ...
  ru: {
    ...
    metaDescription: (p) => `${p.description.ru} ${formatPrice(p.netPricePlnPerKg, 'ru')} зл/кг нетто, заказ от 20 кг. Запросите наличие и фото партии EuroSortex. Доставка по всей территории ЕС, помощь с транспортом.`,
  ...
  uk: {
    ...
    metaDescription: (p) => `${p.description.uk} ${formatPrice(p.netPricePlnPerKg, 'uk')} зл/кг нетто, замовлення від 20 кг. Запитайте наявність і фото партії EuroSortex. Доставка по всій території ЄС, допомога з транспортом.`,
    ...
    faq: (p) => [{ question: `Яке мінімальне замовлення ${p.name}?`, answer: 'Мінімальне замовлення однієї позиції — 20 кг.' }, { question: 'На фото показана саме моя партія?', answer: 'Фото на сторінці показує вид асортименту. До замовлення попросіть менеджера надіслати фото або відео фактично доступної партії.' }, { question: 'Ціна актуальна?', answer: `Ціна в каталозі — ${formatPrice(p.netPricePlnPerKg, 'uk')} зл/кг нетто. Остаточну ціну та наявність менеджер підтверджує до замовлення.` }, { question: 'Як відбувається доставка?', answer: 'Доставка по всій території ЄС зазвичай займає 1–3 тижні після повної передоплати. Транспорт оплачує покупець; ми можемо допомогти з організацією.' }],
  ...
  en: {
    ...
    metaDescription: (p) => `${p.description.en} PLN ${formatPrice(p.netPricePlnPerKg, 'en')}/kg net, 20 kg minimum. Ask EuroSortex for availability and current batch photos. Delivery across the entire EU; transport support.`,
    ...
    faq: (p) => [{ question: `What is the minimum order for ${p.name}?`, answer: 'The minimum order for one assortment line is 20 kg.' }, { question: 'Does the page photo show my exact batch?', answer: 'The page image illustrates the assortment type. Before ordering, ask the manager for photos or video of the batch currently available.' }, { question: 'Is the listed price current?', answer: `The catalogue price is PLN ${formatPrice(p.netPricePlnPerKg, 'en')}/kg net. A manager confirms the final price and availability before you order.` }, { question: 'How does delivery work?', answer: 'We deliver across the entire EU, usually 1–3 weeks after full prepayment. Transport is paid by the buyer; we can help arrange it.' }],
...
export const categoryPageCopy: Record<Locale, Record<ProductCategory, CategoryPageCopy>> = {
  pl: {
    mix: { metaTitle: 'Miksy odzieży używanej hurtowo | EuroSortex', metaDescription: 'Miksy sortowanej odzieży używanej hurtowo dla sklepów second-hand. Porównaj skład, gatunek i ceny netto. Zamówienia od 20 kg, dostawa na terenie całej UE.', title: 'Miksy odzieży używanej hurtowo', lead: 'Uniwersalne partie odzieży i dodatków dla sklepów, outletów i hurtowników. Porównaj skład, gatunek i cenę, a przed zamówieniem poproś o zdjęcia aktualnej partii.', catalogTitle: 'Dostępne miksy odzieży używanej' },
    sweatshirts: { metaTitle: 'Bluzy używane hurtowo dla second-handów | EuroSortex', metaDescription: 'Sortowane bluzy damskie i męskie hurtowo. Gatunek, ceny netto i dostępne miksy bluz dla sklepów second-hand w całej Unii Europejskiej. Minimum 20 kg.', title: 'Bluzy używane w hurcie', lead: 'Miksy bluz damskich i męskich do zatowarowania sklepów second-hand oraz outletów. Dostępność, udział marek i zdjęcia potwierdzamy dla konkretnej partii.', catalogTitle: 'Dostępne miksy bluz' },
    children: { metaTitle: 'Odzież dziecięca używana hurtowo | EuroSortex', metaDescription: 'Sortowana odzież dziecięca używana w hurcie: miksy całoroczne i letnie. Ceny netto, minimum 20 kg i dostawa na terenie całej UE.', title: 'Odzież dziecięca używana hurtowo', lead: 'Sortowane miksy dla dziewczynek i chłopców, dopasowane do regularnego zatowarowania sklepów. Wybierz wariant całoroczny lub sezonowy.', catalogTitle: 'Dostępna odzież dziecięca' },
    pants: { metaTitle: 'Spodnie używane hurtowo | EuroSortex', metaDescription: 'Spodnie dresowe używane hurtowo dla sklepów second-hand: gatunek 1 i 2, ceny netto, zdjęcia aktualnej partii i dostawa na terenie całej UE.', title: 'Spodnie używane w hurcie', lead: 'Sortowane spodnie dresowe damskie i męskie w kilku wariantach jakościowych. Porównaj gatunek, udział marek i bieżącą cenę.', catalogTitle: 'Dostępne spodnie używane' },
    tops: { metaTitle: 'T-shirty i bluzki używane hurtowo | EuroSortex', metaDescription: 'T-shirty i bluzki damskie używane hurtowo. Sortowany asortyment dla second-handów, ceny netto, minimum 20 kg i dostawa na terenie całej UE.', title: 'T-shirty i bluzki używane hurtowo', lead: 'Lekkie pozycje do oferty codziennej i sezonu wiosna–lato. Sprawdź T-shirty oraz miksy bluzek damskich dostępne w hurcie.', catalogTitle: 'Dostępne T-shirty i bluzki' },
    shoes: { metaTitle: 'Obuwie używane hurtowo | EuroSortex', metaDescription: 'Sortowane obuwie używane hurtowo dla sklepów second-hand. Cena netto za kilogram, zamówienia od 20 kg, zdjęcia partii i dostawa na terenie całej UE.', title: 'Obuwie używane w hurcie', lead: 'Sezonowe obuwie sortowane dla sklepów second-hand i outletów. Przed zamówieniem potwierdzamy skład, jakość i pokazujemy aktualną partię.', catalogTitle: 'Dostępne obuwie używane' },
  },
  ru: {
    mix: { metaTitle: 'Миксы одежды second-hand оптом | EuroSortex', metaDescription: 'Миксы сортированной одежды second-hand оптом для магазинов. Состав, сорт и цены нетто. Заказ от 20 кг, доставка по всей территории ЕС.', title: 'Миксы одежды second-hand оптом', lead: 'Универсальные партии одежды и аксессуаров для магазинов, outlet и оптовиков. Сравните состав, сорт и цену, а перед заказом запросите фото партии.', catalogTitle: 'Доступные миксы одежды' },
    ...
    children: { metaTitle: 'Детская одежда second-hand оптом | EuroSortex', metaDescription: 'Сортированная детская одежда second-hand оптом: всесезонные и летние миксы. Цены нетто, от 20 кг, доставка по всей территории ЕС.', title: 'Детская одежда second-hand оптом', lead: 'Сортированные миксы для девочек и мальчиков для регулярного пополнения магазина. Выберите всесезонный или летний вариант.', catalogTitle: 'Доступная детская одежда' },
    pants: { metaTitle: 'Брюки second-hand оптом | EuroSortex', metaDescription: 'Спортивные брюки second-hand оптом для магазинов: 1 и 2 сорт, цены нетто, фото актуальной партии и доставка по всей территории ЕС.', title: 'Брюки second-hand оптом', lead: 'Сортированные женские и мужские спортивные брюки в нескольких вариантах качества. Сравните сорт, долю брендов и цену.', catalogTitle: 'Доступные брюки' },
    tops: { metaTitle: 'Футболки и блузки second-hand оптом | EuroSortex', metaDescription: 'Футболки и женские блузки second-hand оптом. Сортированный товар для магазинов, цены нетто, от 20 кг, доставка по всей территории ЕС.', title: 'Футболки и блузки second-hand оптом', lead: 'Лёгкие позиции для повседневного ассортимента и сезона весна–лето. Сравните футболки и миксы женских блузок.', catalogTitle: 'Доступные футболки и блузки' },
    shoes: { metaTitle: 'Обувь second-hand оптом | EuroSortex', metaDescription: 'Сортированная обувь second-hand оптом для магазинов. Цена нетто за килограмм, заказ от 20 кг, фото партии и доставка по всей территории ЕС.', title: 'Обувь second-hand оптом', lead: 'Сезонная сортированная обувь для магазинов second-hand и outlet. До заказа подтверждаем состав, качество и показываем партию.', catalogTitle: 'Доступная обувь' },
  },
  uk: {
    mix: { metaTitle: 'Мікси одягу second-hand гуртом | EuroSortex', metaDescription: 'Мікси сортованого одягу second-hand гуртом для магазинів. Склад, ґатунок і ціни нетто. Від 20 кг, доставка по всій території ЄС.', title: 'Мікси одягу second-hand гуртом', lead: 'Універсальні партії одягу й аксесуарів для магазинів, outlet і гуртовиків. Порівняйте склад, ґатунок і ціну та попросіть фото партії.', catalogTitle: 'Доступні мікси одягу' },
    ...
    children: { metaTitle: 'Дитячий одяг second-hand гуртом | EuroSortex', metaDescription: 'Сортований дитячий одяг second-hand гуртом: всесезонні та літні мікси. Ціни нетто, від 20 кг, доставка по всій території ЄС.', title: 'Дитячий одяг second-hand гуртом', lead: 'Сортовані мікси для дівчаток і хлопчиків для регулярного поповнення магазину. Оберіть всесезонний або літній варіант.', catalogTitle: 'Доступний дитячий одяг' },
    pants: { metaTitle: 'Штани second-hand гуртом | EuroSortex', metaDescription: 'Спортивні штани second-hand гуртом для магазинів: 1 і 2 ґатунок, ціни нетто, фото актуальної партії та доставка по всій території ЄС.', title: 'Штани second-hand гуртом', lead: 'Сортовані жіночі та чоловічі спортивні штани у кількох варіантах якості. Порівняйте ґатунок, частку брендів і ціну.', catalogTitle: 'Доступні штани' },
    tops: { metaTitle: 'Футболки та блузки second-hand гуртом | EuroSortex', metaDescription: 'Футболки та жіночі блузки second-hand гуртом. Сортований товар, ціни нетто, від 20 кг і доставка по всій території ЄС.', title: 'Футболки та блузки second-hand гуртом', lead: 'Легкі позиції для щоденного асортименту та сезону весна–літо. Порівняйте футболки й мікси жіночих блузок.', catalogTitle: 'Доступні футболки та блузки' },
    shoes: { metaTitle: 'Взуття second-hand гуртом | EuroSortex', metaDescription: 'Сортоване взуття second-hand гуртом для магазинів. Ціна нетто за кілограм, від 20 кг, фото партії та доставка по всій території ЄС.', title: 'Взуття second-hand гуртом', lead: 'Сезонне сортоване взуття для магазинів second-hand і outlet. До замовлення підтверджуємо склад, якість і показуємо партію.', catalogTitle: 'Доступне взуття' },
  },
  en: {
    mix: { metaTitle: 'Wholesale second-hand clothing mixes | EuroSortex', metaDescription: 'Sorted second-hand clothing mixes wholesale for shops. Compare composition, grade and net prices. From 20 kg with delivery across the entire EU.', title: 'Wholesale second-hand clothing mixes', lead: 'Versatile batches of clothing and accessories for shops, outlets and wholesalers. Compare composition, grade and price, then request current batch photos.', catalogTitle: 'Available clothing mixes' },
    ...
    children: { metaTitle: 'Wholesale second-hand children’s clothing | EuroSortex', metaDescription: 'Sorted second-hand children’s clothing wholesale: year-round and summer mixes. Net prices, 20 kg minimum and delivery across the entire EU.', title: 'Second-hand children’s clothing wholesale', lead: 'Sorted girls’ and boys’ mixes for regular shop restocking. Choose between a year-round assortment and a summer line.', catalogTitle: 'Available children’s clothing' },
    pants: { metaTitle: 'Wholesale second-hand trousers | EuroSortex', metaDescription: 'Second-hand sports trousers wholesale for shops: grades 1 and 2, net prices, current batch photos and delivery across the entire EU.', title: 'Second-hand trousers wholesale', lead: 'Sorted women’s and men’s sports trousers in different quality options. Compare the grade, branded share and current price.', catalogTitle: 'Available second-hand trousers' },
    tops: { metaTitle: 'Wholesale second-hand T-shirts and blouses | EuroSortex', metaDescription: 'Second-hand T-shirts and women’s blouses wholesale. Sorted goods, net prices, 20 kg minimum and delivery across the entire EU.', title: 'Second-hand T-shirts and blouses wholesale', lead: 'Lightweight lines for everyday stock and the spring–summer season. Compare T-shirts and women’s blouse mixes available wholesale.', catalogTitle: 'Available T-shirts and blouses' },
    shoes: { metaTitle: 'Wholesale second-hand footwear | EuroSortex', metaDescription: 'Sorted second-hand footwear wholesale for shops. Net price per kilogram, 20 kg minimum, batch photos and delivery across the entire EU.', title: 'Second-hand footwear wholesale', lead: 'Seasonal sorted footwear for second-hand shops and outlets. We confirm composition and quality and show the current batch before ordering.', catalogTitle: 'Available second-hand footwear' },
  },
};
...
export const assortmentPageCopy: Record<Locale, AssortmentPageCopy> = {
  pl: {
    ...
    metaDescription: 'Zobacz hurtowy asortyment sortowanej odzieży używanej EuroSortex: miksy, bluzy, spodnie, odzież dziecięca, T-shirty, bluzki i obuwie. Minimum 20 kg, dostawa na terenie całej UE.',
    ...
    facts: [{ label: 'POZYCJE', value: '12 linii hurtowych' }, { label: 'MINIMUM', value: '20 kg / pozycja' }, { label: 'DOSTAWA', value: 'Cała Unia Europejska' }],
  ...
  ru: {
    ...
    metaDescription: 'Оптовый ассортимент сортированной одежды second-hand EuroSortex: миксы, толстовки, брюки, детская одежда, футболки, блузки и обувь. От 20 кг, доставка по всей территории ЕС.',
    ...
    facts: [{ label: 'ПОЗИЦИИ', value: '12 оптовых линий' }, { label: 'МИНИМУМ', value: '20 кг / позиция' }, { label: 'ДОСТАВКА', value: 'По всей территории ЕС' }],
  ...
  uk: {
    ...
    metaDescription: 'Гуртовий асортимент сортованого одягу second-hand EuroSortex: мікси, світшоти, штани, дитячий одяг, футболки, блузки та взуття. Від 20 кг, доставка по всій території ЄС.',
    ...
    facts: [{ label: 'ПОЗИЦІЇ', value: '12 гуртових ліній' }, { label: 'МІНІМУМ', value: '20 кг / позиція' }, { label: 'ДОСТАВКА', value: 'По всій території ЄС' }],
  ...
  en: {
    ...
    metaDescription: 'Explore EuroSortex wholesale second-hand clothing: mixes, sweatshirts, trousers, children’s wear, T-shirts, blouses and footwear. From 20 kg, delivery across the entire EU.',
    ...
    facts: [{ label: 'LINES', value: '12 wholesale lines' }, { label: 'MINIMUM', value: '20 kg / line' }, { label: 'DELIVERY', value: 'Across the entire EU' }],
