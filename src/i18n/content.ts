...
export interface SiteContent {
  ...
  nav: { offer: string; about: string; quality: string; process: string; terms: string; faq: string; blog: string };
...
const pl: SiteContent = {
  meta: {
    ...
    description: 'Sortowana odzież używana z Europy dla sklepów w całej Unii Europejskiej. 12 pozycji hurtowych, minimum 20 kg, zdjęcia partii i pomoc w organizacji transportu.',
  },
  nav: { offer: 'Oferta', about: 'O nas', quality: 'Jakość', process: 'Jak zamówić', terms: 'Dostawa i płatność', faq: 'FAQ', blog: 'Blog' },
  ...
  hero: {
    ...
    title: 'Hurtownia sortowanej odzieży używanej dla sklepów w całej Unii Europejskiej',
    ...
    facts: [
      ...
      { label: 'ZASIĘG', value: 'Cała Unia Europejska' },
    ],
  },
  benefits: {
  ...
  quality: {
    eyebrow: '03 / JAKOŚĆ', title: 'Jakość i transparentne zasady sortowania', text: 'Każda partia odzieży używanej jest inna. Przed zamówieniem przedstawiamy klasę jakości, dostępne zdjęcia i orientacyjny opis partii.', imageAlt: 'Bele sortowanej odzieży używanej w magazynie EuroSortex',
    principles: [
  ...
  terms: {
    ...
    delivery: { title: 'Dostawa', rows: [
      ...
      { label: 'ZASIĘG', value: 'Na terenie całej Unii Europejskiej' },
  ...
  faq: {
    ...
    items: [
      ...
      { question: 'Jaki jest czas dostawy?', answer: 'Zwykle 1–3 tygodnie od zaksięgowania pełnej przedpłaty. Wysyłka z Warszawy na terenie całej Unii Europejskiej.' },
...
const ru: SiteContent = {
  ...pl,
  meta: { title: 'Оптовый склад сортированной одежды second-hand | EuroSortex', description: 'Сортированная одежда second-hand из Европы для магазинов по всему ЕС. 12 оптовых позиций, заказ от 20 кг, фото партий и помощь с транспортом.' },
  nav: { offer: 'Ассортимент', about: 'О компании', quality: 'Качество', process: 'Как заказать', terms: 'Доставка и оплата', faq: 'FAQ', blog: 'Блог' },
  ...
  hero: { ...pl.hero, eyebrow: 'ОПТОВАЯ ОДЕЖДА SECOND-HAND · ТОЛЬКО B2B', title: 'Оптовый склад сортированной одежды second-hand для магазинов по всему ЕС', text: 'Сортированная одежда из Европы: 12 оптовых позиций. Цены нетто, минимальный заказ 20 кг. Уточните наличие, запросите фото партии и условия сотрудничества.', note: 'После короткого разговора подготовим предложение под потребности вашего магазина. Онлайн-продаж нет.', imageAlt: 'Склад EuroSortex с мешками и тюками сортированной одежды', imageLabel: 'СКЛАД / ЕВРОПА', facts: [{ label: 'МОДЕЛЬ', value: 'Только B2B' }, { label: 'ДОСТАВКА', value: '1–3 недели' }, { label: 'ГЕОГРАФИЯ', value: 'Весь ЕС' }] },
...
const uk: SiteContent = {
  ...ru,
  meta: { title: 'Оптовий склад сортованого одягу second-hand | EuroSortex', description: 'Сортований одяг second-hand з Європи для магазинів по всьому ЄС. 12 оптових позицій, замовлення від 20 кг, фото партій і допомога з транспортом.' },
  nav: { offer: 'Асортимент', about: 'Про нас', quality: 'Якість', process: 'Як замовити', terms: 'Доставка й оплата', faq: 'FAQ', blog: 'Блог' },
  ...
  hero: { ...ru.hero, eyebrow: 'ОПТОВИЙ ОДЯГ SECOND-HAND · ЛИШЕ B2B', title: 'Оптовий склад сортованого одягу second-hand для магазинів по всьому ЄС', text: 'Сортований одяг з Європи: 12 оптових позицій. Ціни нетто, мінімальне замовлення 20 кг. Уточніть наявність, запросіть фото партії та умови співпраці.', note: 'Після короткої розмови підготуємо пропозицію для вашого магазину. Онлайн-продажів немає.', imageAlt: 'Склад EuroSortex з мішками й тюками сортованого одягу', imageLabel: 'СКЛАД / ЄВРОПА', facts: [{ label: 'МОДЕЛЬ', value: 'Лише B2B' }, { label: 'ДОСТАВКА', value: '1–3 тижні' }, { label: 'ГЕОГРАФІЯ', value: 'Увесь ЄС' }] },
  ...
  terms: { eyebrow: '05 / ДОСТАВКА Й ОПЛАТА', title: 'Доставка й оплата — зрозумілі умови', delivery: { title: 'Доставка', rows: [{ label: 'СТРОК', value: '1–3 тижні після зарахування повної передплати' }, { label: 'ГЕОГРАФІЯ', value: 'По всій території ЄС' }, { label: 'ВАРТІСТЬ', value: 'Транспорт оплачує покупець' }, { label: 'ОРГАНІЗАЦІЯ', value: 'Допомагаємо організувати транспорт; можливий самовивіз' }] }, payment: { title: 'Оплата', rows: [{ label: 'ФОРМА', value: '100% передплата до відправлення' }, { label: 'ПЕРЕКАЗ', value: 'Банківський переказ за фактурою' }, { label: 'ПРОПОЗИЦІЯ', value: 'Деталі підтверджує менеджер' }], note: 'Умови співпраці узгоджуються індивідуально з менеджером.' } },
  ...
  faq: { eyebrow: '06 / FAQ', title: 'Часті запитання', items: [{ question: 'Ви продаєте вроздріб?', answer: 'Ні. Ми працюємо лише оптом B2B — з магазинами second-hand, аутлетами й оптовиками.' }, { question: 'Чи можна купити товар онлайн?', answer: 'Немає кошика й онлайн-оплати. Замовлення узгоджується з менеджером у WhatsApp і телефоном.' }, { question: 'Як побачити товар до замовлення?', answer: 'Ми надішлемо фото або відео доступної партії із зазначенням ґатунку й орієнтовного складу.' }, { question: 'Який строк доставки?', answer: 'Зазвичай 1–3 тижні після зарахування повної передплати. Відправлення з Варшави, доставка по всій території ЄС.' }, { question: 'Хто оплачує транспорт?', answer: 'Транспорт оплачує покупець. Ми можемо допомогти з організацією; можливий власний перевізник або самовивіз.' }, { question: 'Які умови оплати?', answer: '100% передплата банківським переказом за фактурою до відправлення.' }, { question: 'Яке мінімальне замовлення?', answer: 'Мінімальне замовлення для кожної позиції — 20 кг.' }] },
...
const en: SiteContent = {
  ...pl,
  meta: { title: 'Wholesale sorted second-hand clothing across the EU | EuroSortex', description: 'European sorted second-hand clothing for shops across the EU. 12 wholesale lines, 20 kg minimum order, batch photos and transport support.' },
  nav: { offer: 'Offer', about: 'About us', quality: 'Quality', process: 'How to order', terms: 'Delivery & payment', faq: 'FAQ', blog: 'Blog' },
  ...
  hero: { ...pl.hero, eyebrow: 'WHOLESALE SECOND-HAND CLOTHING · B2B ONLY', title: 'Wholesale sorted second-hand clothing for shops across the EU', text: 'European sorted second-hand clothing in 12 wholesale lines. Net prices and a 20 kg minimum order. Ask about current availability, batch photos and cooperation terms.', note: 'After a short conversation, we prepare an offer matched to your shop. We do not sell online.', imageAlt: 'EuroSortex warehouse with bags and bales of sorted second-hand clothing', imageLabel: 'WAREHOUSE / EUROPE', facts: [{ label: 'MODEL', value: 'B2B only' }, { label: 'DELIVERY', value: '1–3 weeks' }, { label: 'COVERAGE', value: 'Entire EU' }] },
  ...
  quality: { ...pl.quality, eyebrow: '03 / QUALITY', title: 'Quality and transparent sorting rules', text: 'Every second-hand clothing batch is different. Before ordering, we provide its quality grade, available photos and an approximate description.', imageAlt: 'Bales of sorted second-hand clothing in the EuroSortex warehouse', principles: [{ title: 'Product classification', text: 'Every batch is described according to its stated quality grade.' }, { title: 'Batch photos', text: 'Before you decide, we send photos of the available batch on WhatsApp.' }, { title: 'Transparent description', text: 'Proportions are approximate because the actual composition varies by batch.' }] },
